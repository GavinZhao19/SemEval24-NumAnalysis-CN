from src.llm.base import BaseLM
from src.utils import auto_import


class OpenAIGPT(BaseLM):

    def __init__(self, api_key, model_name, temp=0.1, max_tokens=None, assistant_prompt=None,
        ...
        self.__assistant_prompt = assistant_prompt if assistant_prompt is not None else ""
